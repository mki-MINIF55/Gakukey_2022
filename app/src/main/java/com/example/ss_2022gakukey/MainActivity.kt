...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        keyData.addAll(listOf("$key #3","$keyName 嬰へ短調", "$dominanto E", "$ambience 暗く神秘的、妖怪的、同じに情熱的\n"))
            keyData.addAll(listOf( "-----------------------------------------------------------------------------"))
        keyData.addAll(listOf("$key #4","$keyName ホ長調", "$dominanto #D", "$ambience 輝かしく、温和で喜ばしい。 高貴の調\n"))
            keyData.addAll(listOf( "-----------------------------------------------------------------------------"))
        keyData.addAll(listOf("$key #4","$keyName 嬰ハ短調", "$dominanto B", "$ambience 最も陰暗な調の1つ。 残忍、皮肉、悲愴、不気味\n"))
            keyData.addAll(listOf( "-----------------------------------------------------------------------------"))
